...
void OnOuvrir(GtkWidget* widget, gpointer data) {
  ...
  GtkWidget *dialog = gtk_file_chooser_dialog_new ("Ouvrir Fichier",
      NULL,
...
void OnQuitter(GtkWidget* widget, gpointer data) {
  (void) widget;
  (void) data;
  GtkWidget *pQuestion = gtk_message_dialog_new(GTK_WINDOW(data),
      GTK_DIALOG_MODAL,
...
void OnBruiter(GtkWidget* widget, gpointer data) {
  ...
  /* 1 bouton Valider */
  /* 1 bouton Annuler */
  GtkWidget* pBoite = gtk_dialog_new_with_buttons("bruiter", NULL,
      GTK_DIALOG_MODAL,
      GTK_STOCK_CANCEL,GTK_RESPONSE_CANCEL,
      GTK_STOCK_OK,GTK_RESPONSE_OK,
      NULL);
...
void OnFiltrer(GtkWidget* widget, gpointer data) {
  ...
  GtkWidget *dialog = gtk_file_chooser_dialog_new ("Ouvrir Filtre",
      NULL,
      GTK_FILE_CHOOSER_ACTION_OPEN,
      GTK_STOCK_CANCEL, GTK_RESPONSE_CANCEL,
      GTK_STOCK_OPEN, GTK_RESPONSE_ACCEPT,
  ...
  if (gtk_dialog_run(GTK_DIALOG (dialog)) == GTK_RESPONSE_ACCEPT) {
    char *nom_fichier = gtk_file_chooser_get_filename(GTK_FILE_CHOOSER(dialog));
    noyau_t *noy = charger_noyau(nom_fichier);
...
void OnAbout(GtkWidget* widget, gpointer data) {
  (void) widget;
  GtkWidget *pAbout = gtk_message_dialog_new (GTK_WINDOW(data),
      GTK_DIALOG_MODAL,
      GTK_MESSAGE_INFO,
      GTK_BUTTONS_OK,
